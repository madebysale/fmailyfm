...
const[dataapi,setDataapi] = useState([])
    ...
    useEffect(() => {
        ...
        axios
          .post("http://localhost:8000/viewdetail",
          {
            id: params.id
          })
  ...
  return (
    ...
    {
    dataapi.map((type)=>{
       console.log(type.qty_total,"type")
       console.log(type.costtax,"type")
       return(
                <> 
      ...
      return ( 
         ...
         <div className=" total-amount" > <p>Ordered Amount: $ {type.cost_total}</p>
               <p>+ABST 2</p>
               <p>Total Amount: ${type.costtax}</p></div>
          ...
          <Pdf props={{handleFunction:dataapi}} />
